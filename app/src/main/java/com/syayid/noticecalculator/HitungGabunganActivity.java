...
public class HitungGabunganActivity extends AppCompatActivity {
    ...
    private List<Spinner> spinnerList, proresifSpinnerList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hitung_gabungan);
        context = this;
        ...
        proresifSpinnerList = new ArrayList<>();
        setHeader();
...
//                        dialog.dismiss(); // Menutup dialog
    ...
    private void addNewSpinner() {
        ...
        layoutParamsSpinner.weight = 0.5f;
        ...
        removeBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                proresifSpinnerList.remove(progSpinner);
            }
        });
        ...
        proresifSpinnerList.add(progSpinner);
    }
    ...
    private void handleSubmit() {
        ...
        for (int i = 0; i < spinnerList.size(); i++) {
            ...
            Spinner spogInput = proresifSpinnerList.get(i);
            String numberProg = spogInput.getSelectedItem().toString();
            ...
            progresifs.add(numberProg);
        }


            // Lanjutkan dengan proses checkout karena tidak ada kursi yang duplikat
            Intent intent = new Intent(this, HasilGabunganActivity.class);
    ...
    private void setHeader() {
        ...
        layout.addView(setTV(context, "Jml", layout2, Typeface.BOLD, 15, 0));
        layout.addView(setTV(context, "Progresif Ke-", layout3, Typeface.BOLD, 15, 0));
